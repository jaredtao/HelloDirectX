...
TEST(testVector2D, test1)
{
    ...
    ASSERT_TRUE(fuzzyCompare(p3.length(), 2.2360679774997898));
    p3.setX(p3.x() + 1);
    ASSERT_EQ(p3.x(), 2);
    p3.setY(p3.y() + 1);
    ASSERT_EQ(p3.y(), 3);
...
TEST(testVector2D, test2)
{
    ...
    p1 += 1.5;
    ASSERT_TRUE(Vector2D(14.5, 8.5) == p1);
    p1 += Vector2D(1, 2);
    ASSERT_TRUE(Vector2D(15.5, 10.5) == p1);

    p1 -= 3;
    ASSERT_TRUE(Vector2D(12.5, 7.5) == p1);
    p1 -= 2.1;
    ASSERT_TRUE(Vector2D(10.4, 5.4) == p1);

    p1 -= Vector2D(1, 2);

    ASSERT_TRUE(Vector2D(9.4, 3.4) == p1);

    p1 *= 2;
    ASSERT_EQ(Vector2D(18.8, 6.8), p1);
    p1 *= 0.1;
    ASSERT_EQ(Vector2D(1.88, 0.68), p1);

    p1 /= 0.5;
    ASSERT_EQ(Vector2D(3.76, 1.36), p1);
...
TEST(testVector2D, test5)
{
    ...
    ASSERT_EQ(Vector4D(1.3, 2.4, 0.0f, 0.f), v4);
}
