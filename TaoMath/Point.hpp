...
{
public:
    constexpr inline Point() : mX(0), mY(0) {}
    constexpr inline Point(Integer x, Integer y) : mX(x), mY(y) {}
    constexpr inline Point(const Point &o) : mX(o.mX), mY(o.mY) {}

    inline bool isNull() const
    {
        return mX == 0 && mY == 0;
    }
    constexpr inline Integer x() const
    {
        return mX;
    }
    constexpr inline Integer y() const
    {
        return mY;
    }
    inline Integer &rx()
    ...
    friend constexpr inline const Point
    ...
    {
        return Point(
            static_cast<Integer>(p1.x() / divisor),
            static_cast<Integer>(p1.x() / divisor));
    }
    ...
    friend inline const Point operator/(const Point &p1, Integer divisor)
    {
        ...
        return Point(
            static_cast<Integer>(p1.x() / divisor),
            static_cast<Integer>(p1.y() / divisor));
    }
    template <
        class T,
    ...
    {
        return Point(
            static_cast<Integer>(p1.x() * factor),
            static_cast<Integer>(p1.y() * factor));
    }
