...
{
public:
    constexpr inline Quaternion() : mX(0), mY(0), mZ(0), mScalar(0) {}
    constexpr inline Quaternion(real scalar, real x, real y, real z)
        : mX(x), mY(y), mZ(z), mScalar(scalar)
    {
    }
    ...
    static Quaternion fromAxes(
        const Vector3D &xAxis, const Vector3D &yAxis, const Vector3D &zAxis);
    static Quaternion
                      fromDirection(const Vector3D &direction, const Vector3D &up);
    ...
    friend constexpr inline const Quaternion
    operator+(const Quaternion &q1, const Quaternion &q2);
    friend constexpr inline const Quaternion
    operator-(const Quaternion &q1, const Quaternion &q2);
    friend constexpr inline const Quaternion
...
{
    return q1.mScalar == q2.mScalar && q1.mX == q2.mX && q1.mY == q2.mY
           && q1.mZ == q2.mZ;
}
constexpr inline bool operator!=(const Quaternion &q1, const Quaternion &q2)
{
...
{
    return fuzzyCompare(q1.mScalar, q2.mScalar) && fuzzyCompare(q1.mX, q2.mX)
           && fuzzyCompare(q1.mY, q2.mY) && fuzzyCompare(q1.mZ, q2.mZ);
}

constexpr inline const Quaternion
operator+(const Quaternion &q1, const Quaternion &q2)
{
    return Quaternion(
        q1.mScalar + q2.mScalar, q1.mX + q2.mX, q1.mY + q2.mY, q1.mZ + q2.mZ);
}
constexpr inline const Quaternion
operator-(const Quaternion &q1, const Quaternion &q2)
{
